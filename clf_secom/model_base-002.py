...
pre_params = dict(
    ...
    fix_imbalance=True, 
    normalize=True, normalize_method='robust',                        ## Default: 'zscore'
    remove_outliers=True, outliers_threshold=0.05,                    ## Default: 0.05
    remove_multicollinearity=True, multicollinearity_threshold=0.95,  ## Default: 0.9
    transformation=True, 
...
if __name__ == "__main__":
    ...
    blender = clf.blend_models(topk_tuned, fold=args.n_folds, choose_better=True, verbose=args.verbose)
